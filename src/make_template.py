...
io_dryrun_json = {'input': ['s3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test1.ReadsPerGene.out.tab', 's3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test2.ReadsPerGene.out.tab', 's3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test3.ReadsPerGene.out.tab'], 'output': ['s3://hubseq-data/test/dnaseq_targeted/run_test1/expressionqc/'],  'alternate_inputs': [], 'alternate_outputs': [], 'program_arguments': '', 'sample_id': MODULE+'_test', 'dryrun': ''}
io_json = {'input': ['s3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test1.ReadsPerGene.out.tab', 's3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test2.ReadsPerGene.out.tab', 's3://hubseq-data/test/dnaseq_targeted/run_test1/rnastar/test3.ReadsPerGene.out.tab'], 'output': ['s3://hubseq-data/test/dnaseq_targeted/run_test1/expressionqc/'],  'alternate_inputs': [], 'alternate_outputs': [], 'program_arguments': '', 'sample_id': MODULE+'_test'}
